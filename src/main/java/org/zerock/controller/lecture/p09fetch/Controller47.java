...
public class Controller47 {
	...
	@GetMapping("sub01")
	@ResponseBody
	private Map<String,String> method01() {
		return Map.of("address","seoul","name","손흥민","age","33");
	}
	...
	public JavaBean19 method5() {
		return mapper.getSupplierById(5);
	}
	...
	public Map<String, String> method10(@RequestBody JavaBean19 supplier) {
		...
		if (cnt == 1) {
			map.put("message", supplier.getId() + "번 고객정보가 변경되었습니다.");
		} else {
			map.put("message", supplier.getId() + "번 고객정보가 변경되지 않았습니다.");
		}
	...
	@ResponseBody
	public Map<String, String> method15(@PathVariable int id){
		Map<String, String> map = new HashMap<>();
