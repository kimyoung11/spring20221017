...
public class Controller35 {
	...
	private void method1() {
		String name1 = mapper.getCustomerNameId(1);
		String name2 = mapper.getCustomerNameId(2);
	...
	private void method2() {
		String name1 = mapper.getEmployeeFirstNameId(1);
		String name2 = mapper.getEmployeeFirstNameId(2);
	...
	private void method6(JavaBean04 p) {
		String c = mapper.getSupplierContactName(p);
