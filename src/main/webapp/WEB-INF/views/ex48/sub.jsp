...
<body>
	...
	<button id="btn1">/ex48/sub01 get : 응답 - 여러 customer list(array)</button>
	...
	<button id="btn2">/ex48/sub02 get : 응답 - 여러 supplier list(array)</button>
		...
		.then(list =>{
			for(const item of list){
				...
				let listItem = `
					...
					<td>\${item.country}</td>
					<td>${item.phone}</td>`
					document.querySelector("#tbody").insertAdjacentHTML("beforeend",listItem);
			}
		})
	});
