				...
				<form id="form1" action="" method="post">
					...
					<div class="mb-3">
						...
						<div class="input-group">
							<input id="emailInput1" class="form-control" type="email" name="email" value="${member.email }" name="email" data-old-value="${member.email }">
							<button disabled="disabled" id="emailButton1" type="button" class="btn btn-outline-secondary">중복확인</button>
						</div>
						<div id="emailText1" class="form-text">이메일 중복확인 해주세요</div>
					</div>
					<div class="mb-3">
						<label for="" class="form-label">
							가입일시 
