...
<body>
	...
	<br>
	<button id="btn9">/ex44/sub09 post 요청 json</button>

	<br>
	<button id="btn11">/ex44/sub03 post 요청 form -> obj -> json</button>
	<form action="" id="form1">
		<input type="text" name="name" id="nameInput1" value="손흥"> <input
			type="text" name="address" id="addressInput1" value="런던">
	</form>
	...
	<button id="btn13">/ex44/sub04 post form->obj->json</button>
	<br> age
	<input type="number" id="ageInput3" value="55">
	<br> name
	<input type="text" id="nameInput3" value="손흥민">
	<br> hasCar
	<input type="checkbox" id="hasCarCheckBox3" value="true">
	<br> food:피자
	<input type="checkbox" name="food" class="foodCheckbox3" value="피자">
	<br> food:햄버거
	<input type="checkbox" name="food" class="foodCheckbox3" value="햄버거">
	<br> food:커피
	<input type="checkbox" name="food" class="foodCheckbox3" value="커피">
	<br>
	...
	<button id="btn16" value="99">/ex44/sub16 get</button> <br>
...
document.querySelector("#btn16").addEventListener("click", function(){
	const data = document.querySelector("#btn16").value;
...
document.querySelector("#btn13").addEventListener("click",function(){
	...
	const checkCar = document.querySelector("#hasCarCheckBox3").value;
...
document.querySelector("#btn7").addEventListener("click", function(){
	fetch(ctx +"/ex44/sub07",{
		...
		body : `{
			"age" : 44,
			"info" : {"address" : ["서울","부산"], "married":false}}`
	});
});
